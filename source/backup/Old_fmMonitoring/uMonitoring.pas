    ...
    begin
      ...
      begin
        ...
        begin
          ...
          then
          begin
            if FindField('BC_PARENTCODE').AsString = '' then stTempCode := 'B' + FillZeroNumber(0,G_nBuildingCodeLength) + FillZeroNumber(0,G_nBuildingCodeLength)
            else stTempCode := 'B' + FillZeroNumber(0,G_nBuildingCodeLength) + FindField('BC_PARENTCODE').AsString;
          end
