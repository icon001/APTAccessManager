...
procedure TfmDoorCardPermit.AdvSmoothPanel2Resize(Sender: TObject);
begin
  inherited;
  lv_packagePermitDoorCardList.Width := AdvSmoothPanel2.Width - 200;
...
procedure TfmDoorCardPermit.AdvSmoothPanel3Resize(Sender: TObject);
begin
  inherited;
  sg_addPermitCardList.Height := AdvSmoothPanel3.Height - sg_addPermitCardList.Top;
  sg_addPermitCardList.Width := AdvSmoothPanel3.Width - 20;
end;

procedure TfmDoorCardPermit.AdvSmoothPanel4Resize(Sender: TObject);
begin
  inherited;
  lv_packagePermitDeleteDoorList.Width := AdvSmoothPanel4.Width - 200;

  pan_deleteSearch.Left := btn_CardPermitDeletePerson.Left - pan_deleteSearch.Width;

end;

procedure TfmDoorCardPermit.AdvSmoothPanel6Resize(Sender: TObject);
begin
  inherited;
  sg_deletePermitCardList.Height := AdvSmoothPanel6.Height - sg_deletePermitCardList.Top;
  sg_deletePermitCardList.Width := AdvSmoothPanel6.Width - 20;
...
begin
  ...
  showmessage('선택 입주자의 권한 등록이 완료 되었습니다.');
end;
