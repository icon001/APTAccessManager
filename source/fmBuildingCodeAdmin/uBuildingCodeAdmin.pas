...
begin
  ...
  if stName = '' then
  begin
    showmessage(stringReplace(dmFormName.GetFormMessage('2','M00015'),'$NAME',lb_CompanyUpdate.Caption.Text,[rfReplaceAll]));
    Exit;
  end;
...
procedure TfmBuildingCodeAdmin.FontSetting;
begin
