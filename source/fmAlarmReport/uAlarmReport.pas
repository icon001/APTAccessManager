...
begin
  ...
  begin
    ...
    begin
      ...
      else aList.ColWidths[L_arrAccessReportIndexArray[i]] := 300;
    end;
  end;
end;
...
begin
  ...
  Try
    ...
    begin
      for i := LOW(L_arrAccessReportIndexArray) to HIGH(L_arrAccessReportIndexArray) do
      begin
        WriteInteger('AlarmReport','IndexArray'+inttostr(i),L_arrAccessReportIndexArray[i]);
      end;
      for i := LOW(L_arrRelAccessReportIndexArray) to HIGH(L_arrRelAccessReportIndexArray) do
      begin
        WriteInteger('AlarmReport','RelIndexArray'+inttostr(i),L_arrRelAccessReportIndexArray[i]);
      end;
      ...
      begin
        ...
        WriteInteger('AlarmReport','RelSizeArray' + inttostr(i),sg_Report.ColWidths[i]);
      end;
    end;
  Finally
    ini_fun.Free;
