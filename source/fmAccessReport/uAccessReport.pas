  ...
  Try
    ...
    begin
      ...
      begin
        ...
        if stDepartCode <> '' then stSql := stSql + ' AND BC_CHILDCODE = ''' + stDepartCode + ''' ';
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if ReportFieldNameList.Strings[i] = 'AC_INPUTTYPE' then stTemp := GetstChangeStateName(stTemp)
            else if ReportFieldNameList.Strings[i] = 'ACTIME' then stTemp := MakeDatetimeStr(stTemp);
