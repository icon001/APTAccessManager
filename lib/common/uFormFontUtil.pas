...
uses
  ...
  Vcl.StdCtrls,Vcl.ExtCtrls,AdvPageControl,AdvPanel,AdvGroupBox,Vcl.Buttons,AdvOfficeButtons;

type
  TdmFormFontUtil = class(TDataModule)
  private
  ...
  private
    ...
    procedure TravelAdvGroupBoxFontSetting(oControl:TAdvGroupBox; aFontName,aFontSize:string);
    procedure TravelAdvOfficeCheckBoxFontSetting(oControl:TAdvOfficeCheckBox;aFontName,aFontSize:string);
    ...
    procedure TravelTSpeedButtonFontSetting(oControl:TSpeedButton;aFontName, aFontSize:string);
...
var
  dmFormFontUtil: TdmFormFontUtil;
...
procedure TdmFormFontUtil.FormAdvOfficeTabSetOfficeStylerSetting(
...
procedure TdmFormFontUtil.FormAdvPreviewMenuOfficeStylerSetting(
...
procedure TdmFormFontUtil.FormAdvToolBarOfficeStylerSetting(oControl:TAdvToolBarOfficeStyler;aFormStyle: string);
var
  stFormStyle : string;
begin
  Exit;
...
procedure TdmFormFontUtil.FormStyleSetting(oControl: TfmASubForm;
...
procedure TdmFormFontUtil.TravelAdvEditFontSetting(oControl: TAdvEdit; aFontName,
  aFontSize: string);
begin
  if aFontName <> '' then
  ...
  begin
    if strtoint(aFontSize) > 0 then
       oControl.Font.Size := strtoint(aFontSize);
  end;
end;

procedure TdmFormFontUtil.TravelAdvEditStyleSetting(oControl: TAdvEdit;
  oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelAdvGlassButtonFontSetting(oControl: TAdvGlassButton;
...
procedure TdmFormFontUtil.TravelAdvGlassButtonStyleSetting(
  oControl: TAdvGlassButton; oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelAdvGroupBoxFontSetting(oControl: TAdvGroupBox;
  aFontName, aFontSize: string);
var
  Loop : Integer;
begin
  ...
  begin
    Try
      ...
      end else if oControl.Controls[Loop] is TAdvOfficeCheckBox then
      begin
        TravelAdvOfficeCheckBoxFontSetting(TAdvOfficeCheckBox(oControl.Controls[Loop]),aFontName,aFontSize);
      end else if oControl.Controls[Loop] is TAdvGlassButton then
      begin
      ...
      begin
        ...
        begin
          if strtoint(aFontSize) > 0 then
            TLabel(oControl).Font.Size := strtoint(aFontSize);
        end;
      ...
      begin
        ...
        begin
          if strtoint(aFontSize) > 0 then
            TEdit(oControl).Font.Size := strtoint(aFontSize);
        end;
      end else if oControl.Controls[Loop] is TPanel then
      begin
      ...
      begin
        ...
        begin
          if strtoint(aFontSize) > 0 then
             TListView(oControl).Font.Size := strtoint(aFontSize);
        end;
      end else if oControl.Controls[Loop] is TAdvPanel then
      begin
        TravelAdvPanelFontSetting(TAdvPanel(oControl.Controls[Loop]),aFontName,aFontSize);
      end else if oControl.Controls[Loop] is TAdvGroupBox then
      begin
        TravelAdvGroupBoxFontSetting(TAdvGroupBox(oControl.Controls[Loop]), aFontName,aFontSize);
      end else if oControl.Controls[Loop] is TSpeedButton then
      begin
        TravelTSpeedButtonFontSetting(TSpeedButton(oControl.Controls[Loop]), aFontName,aFontSize);
      end;
    Except
      continue;
    End;
...
procedure TdmFormFontUtil.TravelAdvOfficeCheckBoxFontSetting(
  oControl: TAdvOfficeCheckBox; aFontName, aFontSize: string);
begin
  if aFontName <> '' then
    oControl.Font.Name := aFontName;
  if isDigit(aFontSize) then
...
procedure TdmFormFontUtil.TravelAdvOfficeTabSetOfficeStylerFontSetting(
...
procedure TdmFormFontUtil.TravelAdvPageBitMapSetting(oControl: TAdvPage;
  aImageDir: string);
var
  Loop : Integer;
  stName : string;
...
procedure TdmFormFontUtil.TravelAdvPageControlStyleSetting(
...
procedure TdmFormFontUtil.TravelAdvPageFontSetting(oControl: TAdvPage; aFontName,
  aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelAdvPageStyleSetting(oControl: TAdvPage;
  oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelAdvPanelFontSetting(oControl: TAdvPanel; aFontName,
  aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelAdvPanelStyleSetting(oControl: TAdvPanel;
  oStyler: TAdvToolBarOfficeStyler);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelAdvPreviewMenuBitMapSetting(
...
procedure TdmFormFontUtil.TravelAdvPreviewMenuFontSetting(oControl: TAdvPreviewMenu;
  aFontName, aFontSize: string);
begin
  if aFontName <> '' then
...
procedure TdmFormFontUtil.TravelAdvSmoothLabelFontSetting(oControl: TAdvSmoothLabel;
  aFontName, aFontSize: string);
begin
  if aFontName <> '' then
...
procedure TdmFormFontUtil.TravelAdvSmoothLabelStyleSetting(
  oControl: TAdvSmoothLabel; oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelAdvSmoothPanelFontSetting(oControl: TAdvSmoothPanel;
  aFontName, aFontSize: string);
var
  Loop : Integer;
  stName : string;
...
procedure TdmFormFontUtil.TravelAdvSmoothPanelStyleSetting(
...
procedure TdmFormFontUtil.TravelAdvSmoothTabPageFontSetting(
...
procedure TdmFormFontUtil.TravelAdvSmoothTabPagerFontSetting(
...
procedure TdmFormFontUtil.TravelAdvSmoothTabPagerStyleSetting(
...
procedure TdmFormFontUtil.TravelAdvSmoothTabPageStyleSetting(
...
procedure TdmFormFontUtil.TravelAdvStringGridFontSetting(oControl: TAdvStringGrid;
  aFontName, aFontSize: string);
begin
  if aFontName <> '' then
  begin
...
procedure TdmFormFontUtil.TravelAdvStringGridStyleSetting(oControl: TAdvStringGrid;
  oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelAdvTabSheetStyleSetting(oControl: TAdvTabSheet;
  oStyler: TAdvToolBarOfficeStyler);
var
  Loop : integer;
begin
...
procedure TdmFormFontUtil.TravelAdvToolBarBitMapSetting(oControl: TAdvToolBar;
  aImageDir: string);
var
  Loop : Integer;
  stName : string;
...
procedure TdmFormFontUtil.TravelAdvToolBarFontSetting(oControl: TAdvToolBar;
  aFontName, aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelAdvToolBarPagerBitMapSetting(
...
procedure TdmFormFontUtil.TravelAdvToolBarPagerFontSetting(
...
procedure TdmFormFontUtil.TravelAdvToolBarPagerStyleSetting(
  oControl: TAdvToolBarPager; oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelAdvToolBarStyleSetting(oControl: TAdvToolBar;
  oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelCurvyPanelFontSetting(oControl: TCurvyPanel;
  aFontName, aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelFormFontSetting(oControl: TfmASubForm; aFontName,
  aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelPageControlFontSetting(oControl: TPageControl;
  aFontName, aFontSize: string);
var
  Loop : Integer;
begin
  ...
  begin
    if strtoint(aFontSize) > 0 then
      TPageControl(oControl).Font.Size := strtoint(aFontSize);
  end;
...
procedure TdmFormFontUtil.TravelPanelFontSetting(oControl: TPanel; aFontName,
  aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelPanelStyleSetting(oControl: TPanel;
  oStyler: TAdvToolBarOfficeStyler);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelTabSheetFontSetting(oControl: TTabSheet; aFontName,
  aFontSize: string);
var
  Loop : Integer;
begin
...
procedure TdmFormFontUtil.TravelTreeViewFontSetting(oControl: TTreeView; aFontName,
  aFontSize: string);
begin
  if aFontName <> '' then
    oControl.Font.Name := aFontName;
...
procedure TdmFormFontUtil.TravelTreeViewStyleSetting(oControl: TTreeView;
  oStyler: TAdvToolBarOfficeStyler);
begin

end;

procedure TdmFormFontUtil.TravelTSpeedButtonFontSetting(oControl: TSpeedButton;
  aFontName, aFontSize: string);
begin
  if aFontName <> '' then
    oControl.Font.Name := aFontName;
...
procedure TdmFormFontUtil.TravelW7PanelFontSetting(oControl: TW7Panel; aFontName,
  aFontSize: string);
var
  Loop : Integer;
  stName : string;
...
procedure TdmFormFontUtil.TravelW7PanelStyleSetting(oControl: TW7Panel;
  oStyler: TAdvToolBarOfficeStyler);
var
  Loop : Integer;
begin
