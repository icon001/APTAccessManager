...
begin
  ...
  dmDBCreate.CreateTB_ALARMCODE;
  dmDBInsert.InsertIntoTB_ALARMCODE_Value('q','화재발생','1','1','1',inttostr(clRed));
  dmDBInsert.InsertIntoTB_ALARMCODE_Value('r','화재복구','1','0','0',inttostr(clWhite));
  dmDBInsert.InsertIntoTB_ALARMCODE_Value('s','비상발생','1','1','1',inttostr(clRed));
  dmDBInsert.InsertIntoTB_ALARMCODE_Value('u','케이스열림','1','1','1',inttostr(clRed));
  dmDBInsert.InsertIntoTB_ALARMCODE_Value('w','케이스닫힘','1','0','0',inttostr(clWhite));
  dmDBUpdate.UpdateTB_CONFIG_Value('COMMON','TABLE_VER','4');
end;

function TDataBaseConfig.Table005VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FormName_Value('4','M00142','알람이벤트','','');
  dmDBInsert.InsertIntoTB_FormName_Value('4','M00143','알람시간','','');
  dmDBInsert.InsertIntoTB_FormName_Value('4','M00144','알람코드','','');
  dmDBInsert.InsertIntoTB_FormName_Value('4','M00145','알람내용','','');

  dmDBUpdate.UpdateTB_CONFIG_Value('COMMON','TABLE_VER','5');
end;

function TDataBaseConfig.Table006VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_ALARMCODE_Value('t','비상복구','1','0','0',inttostr(clWhite));

  dmDBUpdate.UpdateTB_CONFIG_Value('COMMON','TABLE_VER','6');
end;

function TDataBaseConfig.Table007VersionMake: Boolean;
begin
  dmDBInsert.InsertIntoTB_FormName_Value('1','M00063','알람보고서','','');
